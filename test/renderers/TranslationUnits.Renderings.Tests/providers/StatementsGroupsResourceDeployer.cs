/// <summary>
/// StatementsGroupsResourceDeployer.cs
/// Andrea Tino - 2017
/// </summary>
...
namespace Rosetta.Translation.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class StatementsGroupsResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(StatementsGroupsResourceDeployer).Assembly;

        private Type Container => typeof(TestData.StatementsGroups);
    }
}
