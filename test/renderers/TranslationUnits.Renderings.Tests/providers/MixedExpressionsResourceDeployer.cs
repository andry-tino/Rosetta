/// <summary>
/// MixedExpressionsResourceDeployer.cs
/// Andrea Tino - 2017
/// </summary>
...
namespace Rosetta.Translation.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class MixedExpressionsResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(MixedExpressionsResourceDeployer).Assembly;

        private Type Container => typeof(TestData.MixedExpressions);
    }
}
