/// <summary>
/// MethodSignaturesResourceDeployer.cs
/// Andrea Tino - 2017
/// </summary>
...
namespace Rosetta.Translation.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class MethodSignaturesResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(MethodSignaturesResourceDeployer).Assembly;

        private Type Container => typeof(TestData.MethodSignatures);
    }
}
