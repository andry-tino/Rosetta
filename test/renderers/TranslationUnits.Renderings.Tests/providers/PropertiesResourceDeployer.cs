...
namespace Rosetta.Translation.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class PropertiesResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(PropertiesResourceDeployer).Assembly;

        private Type Container => typeof(TestData.Properties);
    }
}
