...
namespace Rosetta.Translation.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class ModulesResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(ModulesResourceDeployer).Assembly;

        private Type Container => typeof(TestData.Modules);
    }
}
