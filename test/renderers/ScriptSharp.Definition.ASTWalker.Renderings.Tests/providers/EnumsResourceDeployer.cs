...
namespace Rosetta.ScriptSharp.Definition.AST.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class EnumsResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(EnumsResourceDeployer).Assembly;

        private Type Container => typeof(TestData.Enums);
    }
}
