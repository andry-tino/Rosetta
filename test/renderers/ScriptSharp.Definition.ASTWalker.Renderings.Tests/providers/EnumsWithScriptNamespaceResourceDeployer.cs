/// <summary>
/// EnumsWithScriptNamespaceResourceDeployer.cs
/// Andrea Tino - 2017
/// </summary>
...
namespace Rosetta.ScriptSharp.Definition.AST.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class EnumsWithScriptNamespaceResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(EnumsWithScriptNamespaceResourceDeployer).Assembly;

        private Type Container => typeof(TestData.EnumsWithScriptNamespace);
    }
}
