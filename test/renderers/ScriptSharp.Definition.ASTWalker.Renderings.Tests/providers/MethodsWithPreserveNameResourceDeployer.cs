/// <summary>
/// MethodsWithPreserveNameResourceDeployer.cs
/// Andrea Tino - 2017
/// </summary>
...
namespace Rosetta.ScriptSharp.Definition.AST.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class MethodsWithPreserveNameResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(MethodsWithPreserveNameResourceDeployer).Assembly;

        private Type Container => typeof(TestData.MethodsWithPreserveName);
    }
}
