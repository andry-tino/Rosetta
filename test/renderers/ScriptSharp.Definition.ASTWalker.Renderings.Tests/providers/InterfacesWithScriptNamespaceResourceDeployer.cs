/// <summary>
/// InterfacesWithScriptNamespaceResourceDeployer.cs
/// Andrea Tino - 2017
/// </summary>
...
namespace Rosetta.ScriptSharp.Definition.AST.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class InterfacesWithScriptNamespaceResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(InterfacesWithScriptNamespaceResourceDeployer).Assembly;

        private Type Container => typeof(TestData.InterfacesWithScriptNamespace);
    }
}
