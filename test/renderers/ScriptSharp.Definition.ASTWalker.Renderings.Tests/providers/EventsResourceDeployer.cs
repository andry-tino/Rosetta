...
namespace Rosetta.ScriptSharp.Definition.AST.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class EventsResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(EventsResourceDeployer).Assembly;

        private Type Container => typeof(TestData.Events);
    }
}
