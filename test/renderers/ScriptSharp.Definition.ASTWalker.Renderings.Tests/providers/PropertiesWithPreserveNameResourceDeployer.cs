/// <summary>
/// PropertiesWithPreserveNameResourceDeployer.cs
/// Andrea Tino - 2017
/// </summary>
...
namespace Rosetta.ScriptSharp.Definition.AST.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class PropertiesWithPreserveNameResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(PropertiesWithPreserveNameResourceDeployer).Assembly;

        private Type Container => typeof(TestData.PropertiesWithPreserveName);
    }
}
