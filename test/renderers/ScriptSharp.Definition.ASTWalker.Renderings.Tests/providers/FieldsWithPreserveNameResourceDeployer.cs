/// <summary>
/// FieldsWithPreserveNameResourceDeployer.cs
/// Andrea Tino - 2017
/// </summary>
...
namespace Rosetta.ScriptSharp.Definition.AST.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class FieldsWithPreserveNameResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(FieldsWithPreserveNameResourceDeployer).Assembly;

        private Type Container => typeof(TestData.FieldsWithPreserveName);
    }
}
