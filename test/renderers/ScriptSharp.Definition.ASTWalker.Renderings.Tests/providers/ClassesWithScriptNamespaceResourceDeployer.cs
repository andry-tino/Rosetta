/// <summary>
/// ClassesWithScriptNamespaceResourceDeployer.cs
/// Andrea Tino - 2017
/// </summary>
...
namespace Rosetta.ScriptSharp.Definition.AST.Renderings.Tests
{
    ...
    /// 
    /// </summary>
    internal class ClassesWithScriptNamespaceResourceDeployer : IResourceProvider
    {
        /// <summary>
        ...
        private Assembly Assembly => typeof(ClassesWithScriptNamespaceResourceDeployer).Assembly;

        private Type Container => typeof(TestData.ClassesWithScriptNamespace);
    }
}
