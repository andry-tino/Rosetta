...
namespace Rosetta.Renderings.Utils
{
    ...
    public class RendererBase
    {
        ...
        public RendererBase(string outputFolderPath)
        {
        ...
        public void Render()
        {
            foreach (Type dataProvider in this.DataProviders)
            {
                this.RenderFromMethodInfoArray(dataProvider);
            }
        }
        ...
        /// 
        /// </summary>
        protected virtual Type[] DataProviders
        {
            get
            {
                return new Type[0];
