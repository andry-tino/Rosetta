...
namespace Rosetta.ScriptSharp.Definition.AST.Factories.UnitTests
{
    ...
    /// <summary>
    /// Tests for <see cref="MethodDefinitionTranslationUnitFactory"/> class.
    /// </summary>
    [TestClass]
    public class MethodDefinitionTUFTest
    {
        private const string ScriptNamespaceOnParameterTypeTestSource = @"
            namespace Namespace1 {
                ...
                public class Class1 { }
                public class Class2 {
                    public void MyMethod(Class1 parameter1) { }
                }
            }
        ";
