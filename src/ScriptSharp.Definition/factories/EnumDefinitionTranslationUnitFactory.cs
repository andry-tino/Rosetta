...
namespace Rosetta.ScriptSharp.Definition.AST.Factories
{
    ...
    public class EnumDefinitionTranslationUnitFactory : EnumTranslationUnitFactory
    {
        ...
        /// <summary>
        /// Copy initializes a new instance of the <see cref="EnumDefinitionTranslationUnitFactory"/> class.
        /// </summary>
        /// <param name="other"></param>
        /// <remarks>
        /// For testability.
        /// </remarks>
        public EnumDefinitionTranslationUnitFactory(EnumDefinitionTranslationUnitFactory other) 
            : base(other)
        {
        }
